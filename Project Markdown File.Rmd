...
kable(alcohol_cat, digits = 2, format = "latex", booktabs=TRUE, caption = "Alcohol Categorization") %>% kable_styling() 
...
kable(BMI_cat, digits = 2, format = "latex", booktabs=TRUE, caption = "BMI Categorization") %>% kable_styling() 
...
kable(Health_cat, digits = 2, format = "latex", booktabs=TRUE, caption = "Sick Days Categorization") %>% kable_styling() 
...
kable(Sleep_cat, digits = 2, format = "latex", booktabs=TRUE, caption = "Sleep Amounts Categorization") %>% kable_styling() 
